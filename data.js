...
This is me. Nice to meet you!`,
    ...
    vocab: [
      {word:"student", pos:"n.", meaning:"学生；（尤指）中学生；研究者，学者"},
      {word:"teacher", pos:"n.", meaning:"教师；老师；导师；教练"},
      {word:"doctor", pos:"n.", meaning:"医生；大夫；博士（学位）"},
      {word:"family", pos:"n.", meaning:"家庭；家族；亲属；子女 adj. 家庭的；一家用的"},
      {word:"sister", pos:"n.", meaning:"姐妹；姐姐/妹妹；（称呼）姑娘；修女"},
      {word:"breakfast", pos:"n.", meaning:"早餐；早饭 v. 吃早餐"},
      {word:"school", pos:"n.", meaning:"学校；上学；学院；学派 v. 教育；训练"},
      {word:"subject", pos:"n.", meaning:"科目；学科；主题；话题；实验对象"},
      {word:"basketball", pos:"n.", meaning:"篮球（运动）"},
      {word:"friend", pos:"n.", meaning:"朋友；友人；支持者 v. 加为好友"},
      {word:"dream", pos:"n.", meaning:"梦想；梦 v. 做梦；梦想；想象"},
      {word:"translator", pos:"n.", meaning:"翻译员；译者；翻译器/翻译软件"},
      {word:"world", pos:"n.", meaning:"世界；地球；领域；人世；众生"},
      {word:"I", pos:"pron.", meaning:"我（主格）"},
      {word:"my", pos:"pron.", meaning:"我的（形容词性物主代词）"},
      {word:"you", pos:"pron.", meaning:"你；你们（主格/宾格）"},
      {word:"he", pos:"pron.", meaning:"他（主格，指男性）"},
      {word:"she", pos:"pron.", meaning:"她（主格，指女性）"},
      {word:"it", pos:"pron.", meaning:"它（主格/宾格，指事物或动物）"},
      {word:"we", pos:"pron.", meaning:"我们（主格）"},
      {word:"they", pos:"pron.", meaning:"他们/她们/它们（主格）"},
      {word:"our", pos:"pron.", meaning:"我们的（形容词性物主代词）"}
    ],
    listeningFocus: [
...
This is my day. What does your day look like?`,
    ...
    vocab: [
      {word:"daily", pos:"adj.", meaning:"日常的；每日的；按日的 n. 日报 adv. 每日，天天"},
      {word:"routine", pos:"n.", meaning:"常规；例行公事；固定程序；一套固定动作 adj. 常规的；例行的"},
      {word:"bathroom", pos:"n.", meaning:"浴室；卫生间；洗手间"},
      {word:"kitchen", pos:"n.", meaning:"厨房；灶间"},
      {word:"uniform", pos:"n.", meaning:"制服；校服 adj. 统一的；一致的；不变的"},
      {word:"cafeteria", pos:"n.", meaning:"食堂；自助餐厅"},
      {word:"important", pos:"adj.", meaning:"重要的；有重大影响的；权威的"},
      {word:"wash", pos:"v.", meaning:"洗；洗脸；洗手；洗涤；冲刷 n. 洗涤；要洗的衣服"},
      {word:"brush", pos:"v.", meaning:"刷；刷净；轻擦 n. 刷子；画笔；轻擦"},
      {word:"cook", pos:"v.", meaning:"烹饪；做饭；烧菜 n. 厨师；炊事员"},
      {word:"dress", pos:"v.", meaning:"穿衣服；给…穿衣；打扮 n. 连衣裙；服装"},
      {word:"ride", pos:"v.", meaning:"骑（马/自行车）；乘坐（交通工具） n. 乘车/骑马出行；旅程"},
      {word:"finish", pos:"v.", meaning:"完成；结束；用完 n. 结尾；完成"},
      {word:"change", pos:"v.", meaning:"改变；更换（衣服）；兑换 n. 变化；零钱"},
      {word:"always", pos:"adv.", meaning:"总是；一直；永远；每次都是"},
      {word:"usually", pos:"adv.", meaning:"通常；一般地；经常"},
      {word:"sometimes", pos:"adv.", meaning:"有时；偶尔；间或"},
      {word:"often", pos:"adv.", meaning:"经常；常常；屡次"},
      {word:"never", pos:"adv.", meaning:"从不；永不；绝不；从来没有"}
    ],
    listeningFocus: [
...
A good friend is like a brother. Mike is not just my friend. He is like a brother to me. I hope we will be friends forever.`,
    ...
    vocab: [
      {word:"friendship", pos:"n.", meaning:"友谊；友情；朋友关系"},
      {word:"elementary school", pos:"n.", meaning:"小学；初级学校"},
      {word:"nervous", pos:"adj.", meaning:"紧张的；焦虑的；神经的；不安的"},
      {word:"glasses", pos:"n.", meaning:"眼镜；玻璃杯（复数）"},
      {word:"smart", pos:"adj.", meaning:"聪明的；机敏的；时髦的；（设备）智能的"},
      {word:"kind", pos:"adj.", meaning:"善良的；仁慈的；友好的 n. 种类；类别"},
      {word:"soccer", pos:"n.", meaning:"足球（运动）"},
      {word:"scientist", pos:"n.", meaning:"科学家；科学工作者"},
      {word:"space", pos:"n.", meaning:"太空；空间；空地；间隔 v. 分隔开"},
      {word:"animal", pos:"n.", meaning:"动物；兽；牲畜 adj. 动物的；肉体的"},
      {word:"meaningful", pos:"adj.", meaning:"有意义的；意味深长的；重要的"},
      {word:"forever", pos:"adv.", meaning:"永远；长久地；总是"},
      {word:"meet → met", pos:"v.", meaning:"遇见；会面；相识（过去式 met）"},
      {word:"sit → sat", pos:"v.", meaning:"坐；就座（过去式 sat）"},
      {word:"tell → told", pos:"v.", meaning:"告诉；讲述；吩咐（过去式 told）"},
      {word:"teach → taught", pos:"v.", meaning:"教；教授；教导（过去式 taught）"},
      {word:"tall → taller", pos:"adj.", meaning:"高的 → 更高的（比较级）"},
      {word:"good → better", pos:"adj.", meaning:"好的 → 更好的（比较级，不规则）"},
      {word:"interesting → more interesting", pos:"adj.", meaning:"有趣的 → 更有趣的（多音节比较级）"}
    ],
    listeningFocus: [
...
By the time summer ends, I will have done many things. I hope this summer will be both fun and meaningful. What are your plans for the summer vacation?`,
    ...
    vocab: [
      {word:"vacation", pos:"n.", meaning:"假期；休假；（学校）寒暑假 v. 度假"},
      {word:"beach", pos:"n.", meaning:"海滩；沙滩；海滨 v. 把（船）拖上岸"},
      {word:"ocean", pos:"n.", meaning:"海洋；大海；大洋"},
      {word:"sandcastle", pos:"n.", meaning:"沙堡；沙塔（sand 沙 + castle 城堡）"},
      {word:"seashell", pos:"n.", meaning:"贝壳；海贝（sea 海 + shell 壳）"},
      {word:"fishing", pos:"n.", meaning:"钓鱼；捕鱼 v. 钓鱼（fish 的动名词）"},
      {word:"surfing", pos:"n.", meaning:"冲浪（运动） v. 冲浪；上网浏览"},
      {word:"camp", pos:"n.", meaning:"营地；夏令营；兵营 v. 露营；扎营"},
      {word:"campfire", pos:"n.", meaning:"篝火；营火（camp 营地 + fire 火）"},
      {word:"adventure", pos:"n.", meaning:"冒险；冒险经历；奇遇 v. 冒险；大胆尝试"},
      {word:"summary", pos:"n.", meaning:"总结；摘要；概括 adj. 概括的；即决的"},
      {word:"dish", pos:"n.", meaning:"菜肴；一道菜；盘子；碟子 v. 盛于碟中"},
      {word:"countryside", pos:"n.", meaning:"乡村；农村；乡下"},
      {word:"childhood", pos:"n.", meaning:"童年；儿童时期（child 孩子 + -hood 名词后缀）"},
      {word:"waste", pos:"v.", meaning:"浪费；滥用；虚度 n. 浪费；废物 adj. 废弃的；荒芜的"},
      {word:"attend", pos:"v.", meaning:"参加；出席；上（学）；注意；照料"},
      {word:"improve", pos:"v.", meaning:"提高；改善；改进；变得更好"},
      {word:"promise", pos:"v.", meaning:"承诺；保证；答应 n. 承诺；诺言；希望"},
      {word:"surprise", pos:"v.", meaning:"使惊讶；使惊喜；出其不意 n. 惊喜；意外的事"},
      {word:"at least", pos:"phr.", meaning:"至少；起码；无论如何"},
      {word:"such as", pos:"phr.", meaning:"例如；比如；诸如…之类"},
      {word:"by the time", pos:"conj.", meaning:"到…的时候（引导时间状语从句）"}
    ],
    listeningFocus: [
...
Every small action matters. If everyone does their part, we can make the Earth a cleaner and healthier place to live.`,
    ...
    vocab: [
      {word:"pollution", pos:"n.", meaning:"污染；污染物；玷污；（环境）公害"},
      {word:"environment", pos:"n.", meaning:"环境；自然环境；生态环境；周围状况"},
      {word:"substance", pos:"n.", meaning:"物质；材料；实质；要旨；毒品"},
      {word:"carbon dioxide", pos:"n.", meaning:"二氧化碳（化学式 CO₂）"},
      {word:"greenhouse effect", pos:"n.", meaning:"温室效应（greenhouse 温室 + effect 效应）"},
      {word:"global warming", pos:"n.", meaning:"全球变暖；全球气候变暖"},
      {word:"fertilizer", pos:"n.", meaning:"肥料；化肥（fertilize 施肥 + -er 名词后缀）"},
      {word:"pesticide", pos:"n.", meaning:"杀虫剂；农药（pest 害虫 + -icide 杀灭剂）"},
      {word:"garbage", pos:"n.", meaning:"垃圾；废物；废话"},
      {word:"recycle", pos:"v.", meaning:"回收利用；循环使用 n. 回收；循环"},
      {word:"release", pos:"v.", meaning:"释放；排放；放走；发布 n. 释放；发布"},
      {word:"damage", pos:"v.", meaning:"损害；破坏；伤害 n. 损害；损失；赔偿金"},
      {word:"cause", pos:"v.", meaning:"引起；导致；造成 n. 原因；事业；理由"},
      {word:"dump", pos:"v.", meaning:"倾倒；丢弃；抛弃 n. 垃圾场；倾倒"},
      {word:"reduce", pos:"v.", meaning:"减少；降低；缩小；使陷入"},
      {word:"reuse", pos:"v.", meaning:"重复使用；再次利用（re- 再次 + use 使用）"},
      {word:"however", pos:"adv.", meaning:"然而；不过；但是；无论如何"},
      {word:"as a result", pos:"phr.", meaning:"因此；结果；所以（引出结果）"},
      {word:"instead", pos:"adv.", meaning:"相反地；代替；反而"}
    ],
    listeningFocus: [
      "被动语态的听力识别（be + 过去分词）",
...
In conclusion, technology has changed the way we communicate, learn, and live our daily lives. While there are some downsides, the benefits are hard to ignore. The question is not whether we should use technology. The question is how we can use it in the best possible way.`,
    ...
    vocab: [
      {word:"technology", pos:"n.", meaning:"科技；技术；工艺；工程技术"},
      {word:"communication", pos:"n.", meaning:"通讯；交流；沟通；信息；通信方式"},
      {word:"convenience", pos:"n.", meaning:"便利；方便；便利设施；省事"},
      {word:"telegram", pos:"n.", meaning:"电报；电文 v. 打电报"},
      {word:"destination", pos:"n.", meaning:"目的地；终点；目标"},
      {word:"urgent", pos:"adj.", meaning:"紧急的；急迫的；催促的"},
      {word:"smartphone", pos:"n.", meaning:"智能手机（smart 智能 + phone 电话）"},
      {word:"app", pos:"n.", meaning:"应用程序；应用软件（application 的缩写）"},
      {word:"platform", pos:"n.", meaning:"平台；站台；讲台；纲领"},
      {word:"privacy", pos:"n.", meaning:"隐私；私密；独处；不受干扰的状态"},
      {word:"concern", pos:"n.", meaning:"担忧；担心；关心的事 v. 涉及；使担忧；关系到"},
      {word:"benefit", pos:"n.", meaning:"好处；益处；福利 v. 受益；有利于"},
      {word:"transform", pos:"v.", meaning:"彻底改变；转变；改造；变形"},
      {word:"communicate", pos:"v.", meaning:"交流；沟通；传达；通信"},
      {word:"deliver", pos:"v.", meaning:"递送；传送；发表（演讲）；接生"},
      {word:"compare", pos:"v.", meaning:"比较；对比；比喻；相比"},
      {word:"ignore", pos:"v.", meaning:"忽视；忽略；不理睬；不理会"},
      {word:"in the past", pos:"phr.", meaning:"在过去；从前（对比标志词）"},
      {word:"in conclusion", pos:"phr.", meaning:"总之；最后；综上所述（总结信号词）"},
      {word:"of course", pos:"phr.", meaning:"当然；自然；毫无疑问"},
      {word:"however", pos:"adv.", meaning:"然而；不过；尽管如此（转折词）"}
    ],
    listeningFocus: [
...
This story reminds us that if you have a goal and you refuse to give up, you can achieve amazing things. No matter how hard life gets, keep going. One day, you will look back and be glad you did.`,
    ...
    vocab: [
      {word:"construction site", pos:"n.", meaning:"建筑工地；施工现场"},
      {word:"brick", pos:"n.", meaning:"砖；砖块；积木 v. 用砖砌/堵住"},
      {word:"cement", pos:"n.", meaning:"水泥；胶合剂 v. 用水泥加固；巩固"},
      {word:"calloused", pos:"adj.", meaning:"长满老茧的；变硬的；冷酷无情的"},
      {word:"scholarship", pos:"n.", meaning:"奖学金；学识；学术成就"},
      {word:"determination", pos:"n.", meaning:"决心；坚定；果断；测定"},
      {word:"director", pos:"n.", meaning:"主任；主管；导演；负责人；校长"},
      {word:"score", pos:"n.", meaning:"分数；成绩；得分 v. 得分；评分；获胜"},
      {word:"graduate", pos:"v.", meaning:"毕业；获得学位 n. 毕业生；研究生"},
      {word:"reminder", pos:"n.", meaning:"提醒；提醒物；催单"},
      {word:"support", pos:"v.", meaning:"支撑；支持；供养；拥护 n. 支持；援助"},
      {word:"ache", pos:"v.", meaning:"疼痛；隐痛；渴望 n. （持续的）疼痛"},
      {word:"afford", pos:"v.", meaning:"承担得起；买得起；提供；给予"},
      {word:"borrow", pos:"v.", meaning:"借；借用（从别人那里借来）"},
      {word:"impress", pos:"v.", meaning:"给…留下深刻印象；使钦佩；铭刻"},
      {word:"pass", pos:"v.", meaning:"通过（考试）；经过；传递；及格 n. 通行证"},
      {word:"achieve", pos:"v.", meaning:"达成；实现；取得（成就）；成功"},
      {word:"situation", pos:"n.", meaning:"处境；情况；形势；局面"},
      {word:"goal", pos:"n.", meaning:"目标；目的；球门；进球得分"},
      {word:"effort", pos:"n.", meaning:"努力；尽力；艰难的尝试；费力的事"}
    ],
    listeningFocus: [
...
In conclusion, artificial intelligence is a powerful technology with the potential to do enormous good. However, like any powerful tool, it must be used carefully and wisely. The decisions we make today about how to develop and regulate AI will shape the future for generations to come. It is up to all of us to ensure that AI serves humanity—not the other way around.`,
    ...
    vocab: [
      {word:"artificial intelligence", pos:"n.", meaning:"人工智能，简称 AI（artificial 人工的 + intelligence 智能）"},
      {word:"algorithm", pos:"n.", meaning:"算法；计算程序；运算法则"},
      {word:"data", pos:"n.", meaning:"数据；资料；信息（单数 datum）"},
      {word:"pattern recognition", pos:"n.", meaning:"模式识别（pattern 模式 + recognition 识别）"},
      {word:"healthcare", pos:"n.", meaning:"医疗保健；医疗卫生（health 健康 + care 护理）"},
      {word:"bias", pos:"n.", meaning:"偏见；偏向；偏心；偏差 v. 使有偏见"},
      {word:"transportation", pos:"n.", meaning:"交通；运输；交通运输系统"},
      {word:"obstacle", pos:"n.", meaning:"障碍；障碍物；绊脚石；阻碍"},
      {word:"analyze", pos:"v.", meaning:"分析；解析；细察；研究"},
      {word:"detect", pos:"v.", meaning:"检测；察觉；发现；探测"},
      {word:"adapt", pos:"v.", meaning:"适应；调整；改编；使适合"},
      {word:"regulate", pos:"v.", meaning:"规范；管控；调节；校准"},
      {word:"ensure", pos:"v.", meaning:"确保；保证；担保；使安全"},
      {word:"in simple terms", pos:"phr.", meaning:"简单来说；通俗地讲（用于简化解释）"},
      {word:"on the other hand", pos:"phr.", meaning:"另一方面（表示对比，常与 on the one hand 搭配）"},
      {word:"in conclusion", pos:"phr.", meaning:"总之；最后；综上所述（结论信号词）"},
      {word:"potential", pos:"n.", meaning:"潜力；潜能；可能性 adj. 潜在的；可能的"},
      {word:"narrow", pos:"adj.", meaning:"狭窄的；狭隘的；勉强的；狭隘的 AI 指专用人工智能"},
      {word:"general", pos:"adj.", meaning:"通用的；一般的；普通的；通用的 AI 指通用人工智能"}
    ],
    listeningFocus: [
...
In conclusion, leadership is not a magic power that only a few lucky people possess. It is a set of skills that can be developed with practice, reflection, and a genuine desire to serve something bigger than oneself. Whether you are leading a small team, a large company, or just yourself, the principles remain the same: have a vision, care about people, make decisions, empower others, and lead by example.`,
    ...
    vocab: [
      {word:"leadership", pos:"n.", meaning:"领导力；领导才能；领导层；领导地位"},
      {word:"vision", pos:"n.", meaning:"愿景；远见；视力；想象；洞察力"},
      {word:"emotional intelligence", pos:"n.", meaning:"情商；情绪智力（简称 EQ，emotional 情绪的 + intelligence 智力）"},
      {word:"integrity", pos:"n.", meaning:"正直；诚实；完整；廉正"},
      {word:"dedication", pos:"n.", meaning:"奉献；献身；专注；落成典礼"},
      {word:"responsibility", pos:"n.", meaning:"责任；职责；义务；负责"},
      {word:"principle", pos:"n.", meaning:"原则；原理；准则；道德规范"},
      {word:"guide", pos:"v.", meaning:"引导；指导；带领 n. 指南；导游；手册"},
      {word:"motivate", pos:"v.", meaning:"激励；激发；成为…的动机"},
      {word:"influence", pos:"v.", meaning:"影响；感化；左右 n. 影响；影响力；势力"},
      {word:"consult", pos:"v.", meaning:"咨询；请教；商议；查阅"},
      {word:"empower", pos:"v.", meaning:"赋能；授权；使能够；增加自主权（em- 使 + power 权力）"},
      {word:"combination", pos:"n.", meaning:"结合；组合；混合体；联合"},
      {word:"characteristic", pos:"n.", meaning:"特征；特点；特性 adj. 典型的；特有的"},
      {word:"behavior", pos:"n.", meaning:"行为；举止；表现；运行方式"},
      {word:"attitude", pos:"n.", meaning:"态度；看法；姿态；姿势"},
      {word:"impact", pos:"n.", meaning:"影响；冲击；撞击 v. 影响；冲击"},
      {word:"pressure", pos:"n.", meaning:"压力；压迫；气压；紧张 v. 施压；迫使"},
      {word:"decisive", pos:"adj.", meaning:"果断的；决定性的；明确的；关键的"}
    ],
    listeningFocus: [
...
In the end, perhaps the ancient philosophers were right after all. As Aristotle wrote over two thousand years ago, "Happiness is the meaning and the purpose of life, the whole aim and end of human existence." The difference is that now we have the data to prove it.`,
    ...
    vocab: [
      {word:"psychology", pos:"n.", meaning:"心理学；心理；心理状态"},
      {word:"positive psychology", pos:"n.", meaning:"积极心理学（positive 积极的 + psychology 心理学）"},
      {word:"mindset", pos:"n.", meaning:"心态；思维模式；观念模式（mind 头脑 + set 设定）"},
      {word:"gratitude", pos:"n.", meaning:"感恩；感激之情；谢意"},
      {word:"mindfulness", pos:"n.", meaning:"正念；专注当下；留神；觉察（mindful 留心的 + -ness 名词后缀）"},
      {word:"resilience", pos:"n.", meaning:"韧性；恢复力；适应力；弹性"},
      {word:"setback", pos:"n.", meaning:"挫折；阻碍；倒退（set 设置 + back 向后）"},
      {word:"altruism", pos:"n.", meaning:"利他主义；无私（altru- 他人 + -ism 主义）"},
      {word:"byproduct", pos:"n.", meaning:"副产品；附带结果（by- 附带地 + product 产品）"},
      {word:"thrive", pos:"v.", meaning:"茁壮成长；兴旺发达；蓬勃发展"},
      {word:"contribute", pos:"v.", meaning:"贡献；捐献；投稿；导致（contribute to 有助于）"},
      {word:"predict", pos:"v.", meaning:"预测；预言；预告；预计"},
      {word:"appreciate", pos:"v.", meaning:"欣赏；感激；赏识；领会；升值"},
      {word:"activate", pos:"v.", meaning:"激活；启动；使活跃；触发"},
      {word:"according to", pos:"phr.", meaning:"据…所说/观点；依照；根据（引述来源）"},
      {word:"in fact", pos:"phr.", meaning:"事实上；实际上（强调真实情况）"},
      {word:"paradoxically", pos:"adv.", meaning:"矛盾的是；自相矛盾地；看似不合常理地"},
      {word:"meanwhile", pos:"adv.", meaning:"与此同时；在此期间；另一方面"},
      {word:"after all", pos:"phr.", meaning:"毕竟；终究；别忘了（让步/解释）"},
      {word:"be wired to", pos:"phr.", meaning:"天生就…；与生俱来地…（wire 原意「接线」，引申为「天生设定」）"},
      {word:"helper's high", pos:"phr.", meaning:"助人快感；帮助他人后产生的愉悦感（helper 帮助者 + high 兴奋感）"},
      {word:"pursuit", pos:"n.", meaning:"追求；追赶；爱好；事业"},
      {word:"constructive", pos:"adj.", meaning:"建设性的；积极的；有益的"}
    ],
    listeningFocus: [
